...
class ImprovedFFTKernel(nn.Module):                #MSFF-FE
    def __init__(self, dim) -> None:
        super().__init__()
...
class FrequencyFocusedDownSampling(nn.Module):  # Downsample x2分支 with parallel FGM         FD
    def __init__(self, c1, c2):  
        super().__init__()
        self.c = c2 // 2
        self.cv1 = Conv(c1 // 2, self.c, 3, 2, 1)
...
class SemanticAlignmenCalibration(nn.Module):  # SAM
